...
ENEMY_SHOOT_TIMEOUT = 1.6   # Задержка между выстрелами
...
BOSS_ENEMY_SHOOT_TIMEOUT = 1.7   # Задержка между выстрелами
...
PKL_UPDATE_TIMEOUT = 0.8   # Задержка между обновлениями значения
#-------------------------------------------------------------------------------
