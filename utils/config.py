...
# Игрок
PLAYER_SPEED = 0.48   # Скорость перемещения
PLAYER_HP_MAX = 100   # Здоровье
PLAYER_PLASMA_SPEED = 0.9   # Скорость плазмы
PLAYER_PLASMA_OFFSET = (-20, -10)   # Диапазон урона от плазмы
#-------------------------------------------------------------------------------

# Привидение
ENEMY_SPEED = 0.45   # Скорость перемещения
ENEMY_FRAME_SIZE = (84, 84)   # Размер рамки для столкновений
ENEMY_SHOOT_TIMEOUT = 600   # Задержка между выстрелами
ENEMY_VEER_TIMEOUT = (1000, 3000)   # Диапазон задержки между автоматическими сменами курса
...
ENEMY_PLASMA_SPEED = 0.8   # Скорость плазмы
...
BOSS_ENEMY_VEER_TIMEOUT = (1000, 3000)   # Диапазон задержки между автоматическими сменами курса
BOSS_ENEMY_HP_MAX = 300   # Здоровье
BOSS_ENEMY_SPAWN_DELAY = 3   # Раз во сколько волн появляется
BOSS_ENEMY_PLASMA_SPEED = 0.75   # Скорость плазмы
